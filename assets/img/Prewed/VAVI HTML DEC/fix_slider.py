...
file_path = r"d:\website\VAVI HTML DEC\pages\pre-wedding.html"
new_content = r"""                        <div class="slides__wrapper">
                            <div class="slides">
                                <!-- slide 1 -->
...
start_marker = '<div class="slides__wrapper">'
end_marker = '<div class="text-container"'

start_index = content.find(start_marker)
end_index = content.find(end_marker)

if start_index != -1 and end_index != -1:
    final_content = content[:start_index] + new_content + "\n" + (" " * 56) + content[end_index:]
    # Added indentation before text-container for safety/aesthetics, though HTML doesn't care.

    with open(file_path, "w", encoding="utf-8") as f:
        f.write(final_content)
    print("Successfully replaced slides__wrapper!")
else:
